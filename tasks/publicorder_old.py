...
def publicOrder(orderid):
    ...
    try:
        ...
        body = """ 
                                    <p>Если у вас есть вопрос, нажмите кнопку <strong>Задать вопрос</strong> в верхнем баннере и заполните открывшуюся форму. Ответ будет опубликован в таблице ниже.</p>
                                    <p>Вводите ключевые слова в поле поиска над таблицей. В ней будут отображаться строки, содержащие совпадения.</p>
                                    <p>
                                        <br/>
                                    </p>
                                    <ac:structured-macro ac:macro-id="89142184-e20f-4bc0-a883-674c31cdc128" ac:name="html" ac:schema-version="1">
